    ...
    <section id="partieArticle">
      <article>
        ...
        <div class="descrip">
          ...
          <p class="intro">
            Synopsis :
            <input id="verif1s" class="input" type="checkbox" onclick="cache('verif1s', 'rs1')" />
          </p>
      ...
      <article>
        ...
        <div class="descrip">
          ...
          <p class="intro">
            Synopsis :
            <input id="verif2s" class="input" type="checkbox" onclick="cache('verif2s', 'rs2')" />
          </p>
      ...
      <article>
        ...
        <div class="descrip">
          ...
          <p class="intro">
            Synopsis :
            <input id="verif3s" class="input" type="checkbox" onclick="cache('verif3s', 'rs3')" />
          </p>
      ...
      <article>
        ...
        <div class="descrip">
          ...
          <p class="intro">
            Synopsis :
            <input id="verif4s" class="input" type="checkbox" onclick="cache('verif4s', 'rs4')" />
          </p>
      ...
      <article>
        ...
        <div class="descrip">
          ...
          <p class="intro">
            Synopsis :
            <input id="verif5s" class="input" type="checkbox" onclick="cache('verif5s', 'rs5')" />
          </p>
